...
// const dummyObject = require('../services/mock.repositories.response.json');
...
//   let component: ReposData;
//   let fixture: ComponentFixture<ReposData>;
//   let httpMock: HttpTestingController;
//
//   beforeEach(async () => {
//     TestBed.configureTestingModule({
//       declarations: [ ReposData ],
//       imports: [
...
//     }).compileComponents();
//
//     fixture = TestBed.createComponent(ReposData);
...
//   });
//
//   describe('setStyleClassForCellValue()', () => {
//
//     it('should return true if text is not exist', () => {
//       const result = component.setStyleClassForCellValue(dummyObject.dataMissingObject.branches.master, 'description');
//       expect(result).toBeTruthy();
//     });
//   });
//
...
//
//       const result = component.getBranchName(dummyObject.dataMissingObject.branches, 'master');
...
//
//       const result = component.getBranchName(dummyObject.dataMissingObject.branches, 'development');
...
//
//       const result = component.getPackageValue(dummyObject.dataObject.branches.master, 1, 'typescript');
...
//
//       const result = component.getPackageValue(dummyObject.dataObject.branches.development, 1, 'lodash');
